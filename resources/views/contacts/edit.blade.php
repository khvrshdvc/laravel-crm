    ...
    <div class="max-w-3xl mx-auto px-6 py-8">
        ...
        <form action="{{ route('contacts.update', $contact) }}" method="POST"
            ...
            <div class="flex justify-between items-center mt-8 pt-6 border-t border-gray-100">
                <button type="submit" form="delete-contact-form" class="text-sm text-red-500 hover:text-red-700">
                    Delete contact
                </button>
        ...
        <form id="delete-contact-form" action="{{ route('contacts.destroy', $contact) }}" method="POST"
            onsubmit="return confirm('Delete this contact?')" class="hidden">
            @csrf
            @method('DELETE')
        </form>
