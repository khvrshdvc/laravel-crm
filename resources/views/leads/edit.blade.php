<x-app-layout>
    <div class="max-w-3xl mx-auto px-6 py-8">
        ...
        <form action="{{ route('leads.update', $lead) }}" method="POST"
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="title" name="title" value="{{ old('title', $lead->title) }}"
                ...
                <div>
                    ...
                    @php
                        $currentStatus = old('status', $lead->status->value ?? $lead->status);
                    @endphp
            ...
            <div class="flex justify-between items-center mt-8 pt-6 border-t border-gray-100">
                <button type="submit" form="delete-lead-form" class="text-sm text-red-500 hover:text-red-700">
                    Delete lead
                </button>
        ...
        <form id="delete-lead-form" action="{{ route('leads.destroy', $lead) }}" method="POST"
            onsubmit="return confirm('Delete this lead?')" class="hidden">
            @csrf
            @method('DELETE')
        </form>
