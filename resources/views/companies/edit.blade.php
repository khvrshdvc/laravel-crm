            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="address" name="address" rows="3"
                        class="mt-2 w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900/10 focus:border-gray-900">{{ old('address', $company->address) }}</textarea>
