<x-app-layout>
    <div class="max-w-3xl mx-auto px-6 py-8">
        ...
        <form action="{{ route('companies.store') }}" method="POST" class="bg-white border border-gray-200 rounded-xl p-6">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="address" name="address" rows="3"
                        class="mt-2 w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900/10 focus:border-gray-900">{{ old('address') }}</textarea>
